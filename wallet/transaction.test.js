...
describe('Transaction', () => {
	...
	beforeEach( () => {
		...
		recipient = 'recippient-public-key';
		amount = 50;
	...
	describe('outputMap', () => {
		...
		it('output the amount to th recipient ', () => {
	...
	describe('validTransaction()', () => {
		...
		describe('when the transaaction is valid', () => {
			it('returns true', () => {
				expect(Transaction.validTransaction(transaction)).toBe(true);
			});
		});

	describe('whe the transaction is invalid', () => {
	...
	describe('rewardTransaction()', () => {
		...
		it('creates a one transaction for mining reward', () => {
